...
$sqlinsert="INSERT INTO cabventas (idventa, idclie, idvend , timb, nro, idcaja, efectivo, cheque, tarjeta, chequead, girost, depoban, idsucursal, ualta, falta, activo, tipofac, vence, exentas, grav5, grav10, iva5, iva10, tipvta, timbrado, estado, idmoneda, idtimb) VALUES (".$idventa.", ".$clie.", ".$_SESSION['login_vendedor'].", '".$_SESSION['login_timb']."', ".$nro.", ".$_SESSION['login_idcaja'].", ".$_POST["efectivo"].", ".$_POST["cheque"].", ".$_POST["tarjeta"].", ".$_POST["chequead"].", ".$_POST["giros"].", ".$_POST["depositoban"].", ".$_SESSION['login_sucursal'].", ".$_SESSION['login_idusu'].", '".$fecha."', 1, ".$_POST['tipovta'].", '".$nuevafecha."', 0, 0, ".$gravada10.", 0, ".$iva10.", ".$_SESSION['login_deposito'].", ".$_SESSION['login_timbrado'].", 1, 1,".$_SESSION['login_idtimb'].")";
